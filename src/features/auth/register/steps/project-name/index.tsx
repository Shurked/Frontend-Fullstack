      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-4 bg-white relative min-h-screen">
        ...
        <div className="w-full max-w-sm relative z-10 flex flex-col justify-center h-full mx-auto">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-[#172B4D] mb-2 text-center">
            Nombra tu primer proyecto
          </h1>
          <p className="text-[#7A869A] text-sm text-center mb-6">
            Los proyectos dan vida a su trabajo, ayudando a su equipo a realizar un seguimiento del progreso, mantenerse organizado y administrar tareas.
          </p>

          {/* Input nombre de proyecto */}
          <div className="mb-4">
            <label htmlFor="projectName" className="block text-[#172B4D] font-medium mb-2 text-left">
          ...
          {/* Ejemplos */}
          <div className="mb-6 bg-[#F4F5F7] rounded-lg p-3">
            <span className="block text-[#172B4D] font-semibold text-sm mb-1">Nombres de ejemplo:</span>
            <span className="block text-[#7A869A] text-sm">Bug tracking, React project, Product launch, etc.</span>
          </div>
